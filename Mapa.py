...
df_predicciones = pd.read_csv("C:\\Users\\PC\\Desktop\\PP Agua\\df_predicciones.csv")
# Cargar el shapefile de México
mexico = gpd.read_file("C:\\Users\\PC\\Desktop\\PP Agua\\mexicoHigh.json")  # Cambia esto a la ruta de tu shapefile
